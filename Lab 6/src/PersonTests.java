...
public class PersonTests {
	...
	public void setUp()
	{
        ...
        s1 = new Student();
        s1.setName("Christian");
        s1.setAddress("301 15th St. NW, Charlottesville");
        list.add(s1);
	}
	...
	public void testPersonEmployeeStudent() 
	{
        ...
        /* Hint: part of the equals() methods that you have written for HW2 and HW3 likely included verifying 
         * that the parameter was of a certain Object type. You can use that same approach in this test method,
         * even if the object you pass is an instance_of a subclass of Person.
         */
        int count = 0;
        for (Object o : list) {
	...
	public void testCollectionsSort() 
	{
        ...
        // MAKE SURE TO COMMENT OUT THE LINE BELOW WHEN YOU'RE DONE
        // fail("Have you implemented testPersonEmployeeStudent() yet? You not done until you've commented out this line!");
	}
